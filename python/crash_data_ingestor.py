    ...
    def _read_main_crash_data(self):
        ...
        ret = self._safe_sql_execute(
            ...
            WHEN NOT MATCHED THEN
                ...
                vals.SUPERVISORYDATE, vals.SURFACECONDITION, vals.TRAFFICCONTROL, vals.TRAFFICCONTROLFUNCTIONING, v
                als.UPDATEDATE, vals.UPLOADVERSION, vals.VERSIONNUMBER, vals.WEATHER);
            """, data)
