...
class Crash(Base):
    ...
    HITANDRUN = Column(Boolean)  # <xs:element name="HITANDRUN"> nillable to handle the Unknown option
    ...
    LANETYPE = Column(String)  # <xs:element type="xs:string" name="LANETYPE" nillable="true"/>
    ...
    NONTRAFFIC = Column(Boolean)  # <xs:element name="NONTRAFFIC"> nillable to handle the Unknown option
    NUMBEROFLANES = Column(String)  # <xs:element type="xs:string" name="NUMBEROFLANES"/>
    OFFROADDESCRIPTION = Column(String)  # <xs:element type="xs:string" name="OFFROADDESCRIPTION" nillable="true"/>
    ...
    PHOTOSTAKEN = Column(Boolean)  # <xs:element name="PHOTOSTAKEN"> nillable to handle the Unknown option
    PEOPLE = relationship(
...
class Approval(Base):
    ...
    CADSENT = Column(String)  # <xs:element type="xs:string" name="CADSENT" nillable="true"/>
    CADSENT_DATE = Column(DateTime)  # <xs:element type="xs:string" name="CADSENT_DATE" nillable="true"/>
    ...
    HISTORICALAPPROVALDATAs = Column(String,
                                     )  # <xs:element type="xs:string" name="HISTORICALAPPROVALDATAs" nillable="true"/>
...
class PersonInfo(Base):
    ...
    CONTINUEDIRECTION = Column(String)
    ...
    SUBSTANCEUSE = Column(Integer)  # <xs:element type="xs:byte" name="SUBSTANCEUSE"/>
...
class Person(Base):
    ...
    COMPANY = Column(String)  # <xs:element type="xs:string" name="COMPANY" nillable="true"/>
    COUNTRY = Column(String)  # <xs:element type="xs:string" name="COUNTRY" nillable="true"/>
    COUNTY = Column(String)  # <xs:element type="xs:string" name="COUNTY" nillable="true"/>
    DLCLASS = Column(String)  # <xs:element type="xs:string" name="DLCLASS" nillable="true"/>
    ...
    HOMEPHONE = Column(String)  # <xs:element type="xs:string" name="HOMEPHONE" nillable="true"/>
    LASTNAME = Column(String)  # <xs:element type="xs:string" name="LASTNAME"/>
    MIDDLENAME = Column(String)  # <xs:element type="xs:string" name="MIDDLENAME" nillable="true"/>
    ...
    RACE = Column(String)  # <xs:element type="xs:string" name="RACE" nillable="true"/>
    REPORTNUMBER = Column(String(length=REPORTNUMBER_LEN),
                          ForeignKey('acrs_crash.REPORTNUMBER'))  # <xs:element type="xs:string" name="REPORTNUMBER"/>
...
class Vehicle(Base):
    ...
    HITANDRUN = Column(Boolean)  # <xs:element name="HITANDRUN"> (restricted to 'Y', 'N', and 'U')
    ...
    MAINIMPACT = Column(Integer)  # <xs:element type="xs:string" name="MAINIMPACT"/>
    ...
    VEHICLEMOVEMENT = Column(Float)  # <xs:element type="xs:float" name="VEHICLEMOVEMENT"/>
    VEHICLEREMOVEDBY = Column(String)  # <xs:element type="xs:string" name="VEHICLEREMOVEDBY" nillable="true"/>
    VEHICLEREMOVEDTO = Column(String)  # <xs:element type="xs:string" name="VEHICLEREMOVEDTO" nillable="true"/>
    VEHICLETOWEDAWAY = Column(String(length=1))  # <xs:element name="VEHICLETOWEDAWAY"> (restricted to Y, N, U and '')
...
class CommercialVehicle(Base):
    ...
    HAZMATNAME = Column(String)  # <xs:element type="xs:string" name="HAZMATNAME" minOccurs="0" nillable="true"/>
    HAZMATNUMBER = Column(String)  # <xs:element type="xs:string" name="HAZMATNUMBER" minOccurs="0" nillable="true"/>
    ...
    WEIGHT = Column(String)  # <xs:element type="xs:string" name="WEIGHT" minOccurs="0" nillable="true"/>
    WEIGHTUNIT = Column(String)  # <xs:element type="xs:string" name="WEIGHTUNIT" minOccurs="0" nillable="true"/>
