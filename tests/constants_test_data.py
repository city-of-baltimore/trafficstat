...
crash_test_input_data = OrderedDict([
    ...
    ('LATITUDE', '39.25761732688170'),
    ('LIGHT', '03'),
    ('LOCALCASENUMBER', '9201107985'),
    ('LOCALCODES', '3502'),
    ('LONGITUDE', '-76.63281189703950'),
...
crash_test_exp_data = [
    ('2020-11-28 21:59:32.0096310', 'BALTIMORE', 'Baltimore City Police Department', 'UNK', 3, None, None, False, 'N',
     ...
     '2020-11-28 21:59:53.0000000', 3, None, 2, 'BALTIMORED934', None, '03', 'W', 1, None, 39.25761732688170, '03',
     '9201107985', '3502', -76.63281189703950, 'W', 80.0, 'F', 'Test narrative', False, 4, None, False, None, 24,
...
commveh_input_data = OrderedDict([
    ...
    ('POSTALCODE', '21207'),
    ('STATE', 'MD'),
    ('STREET', '1962 WOODLAWN DR APT I'),
    ('VEHICLEID', 'edeaa7cd-06f1-4dde-b318-66a28ec604e0'),
    ('WEIGHT', OrderedDict([('@i:nil', 'true')])),
    ('WEIGHTUNIT', OrderedDict([('@i:nil', 'true')]))])

commveh_exp_data = [(
    '03', 0, 99, 'GWYN OAK', 3, None, '3430518', 99, '10', None, None, 'N', '111139', 'MANSUR LLC',
    3, 'U', '21207', 'MD', '1962 WOODLAWN DR APT I', 'EDEAA7CD-06F1-4DDE-B318-66A28EC604E0', None,
    None)]

# DAMAGED
damaged_input_data = OrderedDict([
    ('DAMAGEDAREA', [
        OrderedDict([
            ('DAMAGEID', '6783466'),
            ('IMPACTTYPE', '06'),
...
# PDF
pdf_input_data = OrderedDict([
    ('PDFREPORTs', OrderedDict([
        ('PDFREPORT', OrderedDict([
...
# PERSON
person_input_data = OrderedDict([
    ('ACRSPERSON', [
        OrderedDict([
            ('ADDRESS', '4403 ONYX CT'),
            ('CITATIONCODES', None),
            ('CITY', 'MIDDLETOWN'),
...
person_exp_data = [
    (
        '4403 ONYX CT', 'MIDDLETOWN', None, None, None, None, 'B650589744192', 'MD', '1997-03-13', 'MATTHEW', None,
        'BROWN',
        None, None, '0BD82E1D-8C96-40C5-B1E4-B4DFC82CB971', None, 'ADD9340058', 'M', 'MD', '21769'),
    ('805 MONTPELIER ST', 'BALTIMORE', None, None, None, None, 'C636762792077', 'MD', '1984-01-29', 'SEAN', None,
     'CARTER', None, None, 'FCD8309C-250A-4FA4-9FDF-D6DAFE2C6946', None, 'ADD9340058', 'M', 'MD', '21218')]

person_citation_exp_data = [('KK15680', 'FCD8309C-250A-4FA4-9FDF-D6DAFE2C6946', 'ADD9340058')]

# PERSON INFO (DRIVER)
person_info_driver_input_data = OrderedDict([
    ('DRIVERs', OrderedDict([
        ('DRIVER', OrderedDict([
            ('AIRBAGDEPLOYED', '02'),
...
person_info_pass_input_data = OrderedDict([
...
person_info_person_pass_exp_data = [
    ('3600 W FRANKLIN STREET', 'BALTIMORE', None, None, None, None, None, None, '1987-06-24', 'KEON', None, 'JONES',
     None, '4439432045', 'FD3DFFBA-C1C6-41DF-9FC5-A45AE4379DB1', None, 'ADJ063005D', 'M', 'MD', '21229')]

# PERSON INFO (PASSENGER) - MULTIPLE
person_info_pass_mult_input_data = OrderedDict([
    ('PASSENGERs', OrderedDict([
        ('PASSENGER', [
            OrderedDict([
                ('AIRBAGDEPLOYED', '01'),
...
person_info_person_mult_pass_exp_data = [
    ('8813 RACHEL COURT', 'ELLICOTT CITY', None, None, None, None, None, None, '2002-06-01', 'ASHLEY', None, 'JEON',
     None, '4437453018', '64F9CDA0-1477-4CB9-8891-67087D4163BC', None, 'ADD90500BB', 'F', 'MD', '21043'),
    ('3720 FONTHILL DR', 'ELLICOTT CITY', None, None, None, None, None, None, '2002-08-18', 'ERIC', None, 'ROH', None,
     '6677861336', '3C348C05-C3C1-44FB-840C-DD5C23CD9811', None, 'ADD90500BB', 'M', 'MD', '21042')
]

# PERSON INFO (NONMOTORIST)
person_info_nonmotorist_input_data = OrderedDict([
    ('NONMOTORISTs', OrderedDict([
        ('NONMOTORIST', OrderedDict([
            ('ALCOHOLTESTINDICATOR', '00'),
            ('ALCOHOLTESTTYPE', OrderedDict([('@i:nil', 'true')])),
            ('ATFAULT', 'N'),
            ('BAC', OrderedDict([('@i:nil', 'true')])),
...
person_info_records_nonmotorist_input_data = [('201 OLDHAM STREET', 'BALTIMORE', None, None, None, None, None, None,
                                               '1962-12-01', 'LINDA', None, 'RICHARDSON', None, '4435226285',
...
# TOWED
towed_input_data = OrderedDict([
    ('TOWEDUNITs', OrderedDict([
        ('TOWEDUNIT', OrderedDict([
            ...
            ('VEHICLEYEAR', '2007'),
            ('VIN', '1GYFK66807R248298')]))]))])

towed_exp_data = [
    ('0923954101', 'GEICO', 'ARS', 'MD', '0EEA2C7F-3F2C-4FD6-ABC2-4927605D237A', '6671F8B9-B7D0-469D-8766-F1D153F72986',
     None, '642F511D-FD4B-4DAF-A6B8-5418546BE524', 'CADILLAC', 'ESCALADE', 2007, '1GYFK66807R248298')]

# VEHICLE DATA
vehicle_input_data = OrderedDict([
    ('VEHICLEs', OrderedDict([
        ('ACRSVEHICLE', [
            OrderedDict([
                ...
                ('GOINGDIRECTION', 'W'),
                ('HITANDRUN', 'N'),
                ('INSURANCEPOLICYNUMBER', '043639358G'),
                ('INSURER', 'USAA'),
                ('LICENSEPLATENUMBER', '1EE4115'),
                ('LICENSEPLATESTATE', 'MD'),
                ('MAINIMPACT', '01'),
                ('MOSTHARMFULEVENT', '01'),
                ('OWNER', None),  # tested in test_read_acrs_person_data
            ...
            OrderedDict([
                ...
                ('VEHICLEUSEs', None),  # tested in test_read_acrs_vehicle_use_data
                ('VEHICLEYEAR', '2013'),
                ('VIN', '5GAKVCKD0DJ123200')])])]))])

vehicle_exp_data = [
    (None, 'W', 2, False, False, None, 1, 'W', False, '043639358G', 'USAA', '1EE4115', 'MD', 1, '01',
     '21732E90-2796-497F-A5C2-5D7877510D4C', False, None, 'ADJ063005D', 0, 25, 0, '1', '23.08',
     '01A1AC19-5C24-4FBE-A001-173574C5CBED', 'GMC', 'ENVOY', 13.0, None, None, None, 2017, '1GKKNULS8HZ284066'),
    (None, 'W', 3, False, False, None, 11, 'W', False, 'G00999263900', 'BRISTOL WEST', 'LGC7840', 'PA', 11, '00',
     'D978BE20-08C7-4FF3-B2E9-A251047AC3A7', False, None, 'ADJ063005D', 0, 0, 0, '2', '23.08',
     '6DDE66E1-433B-4839-9DF8-FFB969D35D68', 'BUICK', 'ENCLAVE', 6.0, None, None, None, 2013, '5GAKVCKD0DJ123200')]

# VEHICLE USE
vehicle_use_input_data = OrderedDict([
    ('VEHICLEUSEs', OrderedDict([
        ('VEHICLEUSE', OrderedDict([
            ('ID', '3696806'),
            ('VEHICLEID', '5f19b3c5-4e3b-4010-9959-506a84632cdb'),
            ('VEHICLEUSECODE', '00')]))]))])
...
# WITNESS
witness_input_data = OrderedDict([
    ('WITNESSes', OrderedDict([
        ('WITNESS', OrderedDict([
            ('PERSON', OrderedDict([
                ('ADDRESS', '3635 ELKADER RD'),
                ('CITATIONCODES', None),
                ('CITY', 'BALTIMORE'),
                ('COMPANY', OrderedDict([('@i:nil', 'true')])),
                ('COUNTRY', OrderedDict([('@i:nil', 'true')])),
...
witness_records_expt_data = [
    ('3635 ELKADER RD', 'BALTIMORE', None, None, None, None, None, None, None, 'TIFFANY', '4109037977', 'DAVIS',
     'CATERIA', None, '6B76FBC7-56E8-4CF5-9D35-DFEB33A4E60D', None, 'ADJ956004Z', None, 'MD', '21218'), ]
...
# MULTPLE ATTR SINGLE
multi_attr_single_input_data = OrderedDict([
    ('TOPELEMENTs', OrderedDict([
        ('TOPELEMENT', OrderedDict([
            ('ELEMENT1', '01'),
            ('ELEMENT2', '02')]))]))])

multi_attr_single_exp_data = [
    OrderedDict([('ELEMENT1', '01'), ('ELEMENT2', '02')])]

# MULTIPLE ATTR MULTIPLE
multi_attr_multi_input_data = OrderedDict([
    ('TOPELEMENTs', OrderedDict([
        ('TOPELEMENT', [
            OrderedDict([
                ('ELEMENT1', '01'),
...
multi_attr_multi_exp_data = [
    OrderedDict([('ELEMENT1', '01'), ('ELEMENT2', '02')]), OrderedDict([('ELEMENT1', '03'), ('ELEMENT2', '04')])]
