...
# Enrich
parser_enrich = subparsers.add_parser('enrich', help='Adds census tract information and cleans roadway infromation in '
                                                     'the roadway tables')
...
# Generate
parser_generate = subparsers.add_parser('generate', help='Generate CSV files that MS2 uses to import crash data. Pulls '
